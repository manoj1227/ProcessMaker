...
describe("ProcessMaker Test Cases", () => {
  ...
  it('TCP4 - 2078', () => {
    ...
    var scriptName = timeStamp + "QA-2078Script";
    var userName = Cypress.env("username");


    var scriptValue = '$array = array (["code"=>" Paola1 ", "value" => "paola1"], ["code" => "paola2", "value" => "paola2"], ["code" => "paola3", "value" => "paola3"]); return ["requestData" => $array];';
