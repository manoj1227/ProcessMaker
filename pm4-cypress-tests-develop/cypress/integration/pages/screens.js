...
export class Screens {
	...
	addNestedScreenControl(data, timeStamp) {
		this.addControl(data.name);
		this.addnestedscreen(data, timeStamp);
	...
	addnestedscreen(data, timeStamp) {
		var name = timeStamp + data.NestedScreen;
		cy.xpath(Selectors.nestedscreenDrpDwnBtn).click({force:true});
